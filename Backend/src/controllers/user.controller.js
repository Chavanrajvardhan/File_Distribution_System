...
const registerUser = asyncHandler(async (req, res) => {
    ...
    let { first_name, middle_name, last_name, email, password, role, center_id, pc_id } = req.body;

    if ([first_name, middle_name, last_name, email, password, role, center_id, pc_id].some((field) => field.trim() === '')) {
...
const loginUser = asyncHandler(async (req, res) => {
    ...
    const { accessToken, refreshToken } = await generateAccessTokenAndRefreshToken(user.user_id);
